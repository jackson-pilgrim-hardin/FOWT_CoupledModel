...
AQWA_File_Folder = "C:\\Users\\orie4859\\Desktop\\IEA_15MW_AeroHydro_AQWA_Model_files\\dp0\\AQW-1\\AQW\\AQ\\Analysis\\"
...
class AqwaServerMgr:
    def __init__(self, port=0):
        ...
        self.hostname = socket.gethostname() #"127.0.0.1"#
        self.port = self.socket.getsockname()[1]
        print("Saving config file in:  " + AQWA_File_Folder + "AQWA_SocketUserForceServerDetails.cfg")

        fd = open(AQWA_File_Folder+"AQWA_SocketUserForceServerDetails.cfg","w")
